...
function get_order_details($connexion, $order_uuid) {
    $query = "SELECT o.order_uuid,o.num_order, o.order_date, o.total_amount, o.status, 
    ...
    $stmt->bindParam(':order_uuid', $order_uuid);
    $stmt->execute();
